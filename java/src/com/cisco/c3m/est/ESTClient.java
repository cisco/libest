...
public class ESTClient {
	...
	public enum AuthMode {
		 ...
		 * note that SRP is not allowed in FIPS mode, which is a constraint imposed by OpenSSL/CiscoSSL.
		 */
		authSRP,
		/**
	 ...
	 * crypto provider. This class leverages CiscoSSL for crypto operations and
	 * FIPS compliance. CiscoJ leverages CiscoSSL as well. When linked as a
	 * shared library, only one copy of CiscoSSL will be resident in memory
	 * under the JVM. Once CiscoSSL is put into FIPS mode, it will impact all
	 ...
	 * CiscoEST. Three possible values may be configured: errors, warnings, or
