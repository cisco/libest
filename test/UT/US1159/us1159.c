...
static unsigned char * handle_csrattrs_request (int *csr_len, void *app_data)
{
...
static void us1159_test1 (void)
{
     ...
     */
    ctx = est_client_init(cacerts, cacerts_len, 
                           EST_CERT_FORMAT_PEM,
                           NULL);
    CU_ASSERT(ctx != NULL);
     ...
     */
    est_client_set_server(ctx, US1159_SERVER_IP, US1159_SERVER_PORT);
...
static EST_ERROR populate_x509_request (X509_REQ *req, EVP_PKEY *pkey, char *cn)
{
    ...
    rv = X509_NAME_add_entry_by_txt(subj, "CN", MBSTRING_ASC, (const unsigned char*)cn, -1, -1, 0);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
     ...
     */
    rv = X509_NAME_add_entry_by_NID(subj, NID_serialNumber, MBSTRING_ASC, (unsigned char*)"12349999B", -1, -1, 0);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_X509_CN);
     ...
     */
    rv = X509_REQ_add1_attr_by_txt(req, "1.3.6.1.1.1.1.22", MBSTRING_ASC, (const unsigned char*)"dummymac", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "2.999.1", MBSTRING_ASC, (const unsigned char*)"dummy", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "2.999.2", MBSTRING_ASC, (const unsigned char*)"dummy", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "2.999.3", MBSTRING_ASC, (const unsigned char*)"dummy", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "2.999.4", MBSTRING_ASC, (const unsigned char*)"dummy", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "1.2.840.10045.2.1", MBSTRING_ASC, (const unsigned char*)"1.3.132.0.34", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_txt(req, "1.2.840.10045.4.3.3", MBSTRING_ASC, (const unsigned char*)"", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
    ...
    rv = X509_REQ_add1_attr_by_NID(req, NID_serialNumber, MBSTRING_ASC, (const unsigned char*)"123456789A", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
        return (EST_ERR_UNKNOWN);
...
static void us1159_test10 (void)
{
     ...
     */
    rv = est_server_init_csrattrs(ectx, US1159_ATTR_CN_ONLY, strlen(US1159_ATTR_CN_ONLY));
    CU_ASSERT(rv == EST_ERR_NONE);
...
static void us1159_test20 (void)
{
	...
	rv = X509_REQ_add1_attr_by_txt(req, t_attr_str, MBSTRING_ASC, (const unsigned char*)"whatever", -1);
        CU_ASSERT(rv != 0);
	if (!rv) {
	    ERR_print_errors_fp(stderr);
	}
...
static void us1159_test21 (void)
{
     ...
     */
    rv = X509_REQ_add1_attr_by_txt(req, "2.993.8", MBSTRING_ASC, (const unsigned char*)"This is an attribute with a very long value that could potentially cause a problem on the EST server.  0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
    }
     ...
     */
    rv = X509_REQ_add1_attr_by_txt(req, "2.993.8.828.85.8142.9999.2.1883.2.993.8.828.85.8142.9999.2.1883.2.993.8.828.85.8142.9999.2.1883.2.993.8.828.85.8142.9999.2.1883.2.993.8.828.85.8142.9999.2.1883.7", MBSTRING_ASC, (const unsigned char*)"0123456789", -1);
    CU_ASSERT(rv != 0);
    if (!rv) {
	ERR_print_errors_fp(stderr);
    }
