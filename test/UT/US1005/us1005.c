...
static int us1005_start_server (int manual_enroll, int nid, int no_http_auth, int enable_pop)
{
    int rv;
 ...
 */
static void us1005_easy_provision (char *cn, char *server, int ba_hint, int use_cert)
{
    EST_CTX *ectx;
    EVP_PKEY *new_key;
    int rv;
     ...
     */
    est_client_set_server(ectx, server, US1005_SERVER_PORT);
...
static void us1005_test5 (void)
{
     ...
     * Set the EST server address/port
     */
    est_client_set_server(ectx, US1005_SERVER_IP, US1005_SERVER_PORT);
