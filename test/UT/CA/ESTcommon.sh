...
rm -f EST_OPENSSL_EXTCADATABASE
git checkout EST_OPENSSL_EXTCADATABASE
echo "00" > EST_OPENSSL_EXTCASERIAL
...
rm -f EST_OPENSSL_CADATABASE
git checkout EST_OPENSSL_CADATABASE
echo "00" > EST_OPENSSL_CASERIAL
