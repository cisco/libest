...
static size_t curl_data_cb (void *ptr, size_t size, size_t nmemb, void *userdata)
{
    void * rc;    
...
static void us1884_test1 (void) 
{
    ...
    rv = curl_http_post(US1884_ENROLL_URL_BA, US1884_PKCS10_CT, 
	                ...
	                US1884_UIDPWD_GOOD, US1884_CACERTS, CURLAUTH_BASIC, 
			NULL, NULL, NULL);
    /* 
...
static void us1884_test2 (void) 
{
    ...
    rv = curl_http_post(US1884_ENROLL_URL_BA, US1884_PKCS10_CT, 
	                US1884_PKCS10_RSA2048, 
	                US1884_UIDPWD_GOOD, US1884_CACERTS, CURLAUTH_DIGEST, 
			NULL, NULL, NULL);
    /* 
