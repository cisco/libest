...
int main (int argc, char **argv) 
{
    ...
    while ((c = getopt_long(argc, argv, "s:p:u:h:c:k:", long_options, &option_index)) != -1) {
        switch (c) {
            case 0:
    ...
    /*
     * Send the Voucher status indication.  This indicates that we've recieved
...
int main (int argc, char **argv) 
{
    printf("CiscoEST was not built with BRSKI support.  Rebuild CiscoEST with --enable-brski configure option.\n");
}
#endif
